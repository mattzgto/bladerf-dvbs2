...
set_clock_groups -asynchronous -group c4_tx_clock -group {U_pll|altpll_component|auto_generated|pll1|clk[1]}
set_clock_groups -asynchronous -group c4_tx_clock -group {U_pll|altpll_component|auto_generated|pll1|clk[2]}
set_clock_groups -asynchronous -group c4_tx_clock -group {U_pll|altpll_component|auto_generated|pll1|clk[4]}

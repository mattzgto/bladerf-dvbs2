...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_filter_rtl_core.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_filter_ast.vhd"                             
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_filter.vhd"                                 

...
//VERSION_BEGIN 17.0 cbx_altbarrel_shift 2017:04:19:09:17:27:SJ cbx_altera_syncram_nd_impl 2017:04:19:09:17:27:SJ cbx_altfp_convert 2017:04:19:09:17:27:SJ cbx_altpriority_encoder 2017:04:19:09:17:27:SJ cbx_altsyncram 2017:04:19:09:17:27:SJ cbx_cycloneii 2017:04:19:09:17:27:SJ cbx_lpm_abs 2017:04:19:09:17:27:SJ cbx_lpm_add_sub 2017:04:19:09:17:27:SJ cbx_lpm_compare 2017:04:19:09:17:27:SJ cbx_lpm_decode 2017:04:19:09:17:27:SJ cbx_lpm_divide 2017:04:19:09:17:27:SJ cbx_lpm_mux 2017:04:19:09:17:27:SJ cbx_mgl 2017:04:19:10:26:36:SJ cbx_nadder 2017:04:19:09:17:27:SJ cbx_stratix 2017:04:19:09:17:27:SJ cbx_stratixii 2017:04:19:09:17:27:SJ cbx_stratixiii 2017:04:19:09:17:27:SJ cbx_stratixv 2017:04:19:09:17:27:SJ cbx_util_mgl 2017:04:19:09:17:27:SJ  VERSION_END
...
//VERSION_BEGIN 17.0 cbx_altbarrel_shift 2017:04:19:09:17:27:SJ cbx_mgl 2017:04:19:10:26:36:SJ  VERSION_END

//synthesis_resources = reg 73 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_to_fixed_altbarrel_shift_00g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[33:0]	sbit_piper1d;
	reg	[33:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	reg	sel_pipec5r1d;
	wire  [6:0]  dir_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 34'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[101:68];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 34'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[203:170];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {32{1'b0}},
		result = sbit_w[237:204],
		sbit_w = {sbit_piper2d, smux_w[169:102], sbit_piper1d, smux_w[67:0], data},
		sel_w = {sel_pipec5r1d, sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({34{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[171:170], pad_w[31:0]}) | ({34{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[203:202]})) | ({34{(~ sel_w[5])}} & sbit_w[203:170])), ((({34{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[153:136], pad_w[15:0]}) | ({34{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[169:152]})) | ({34{(~ sel_w[4])}} & sbit_w[169:136])), ((({34{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[127:102], pad_w[7:0]}) | ({34{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[135:110]})) | ({34{(~ sel_w[3])}} & sbit_w[135:102])), ((({34{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[97:68], pad_w[3:0]}) | ({34{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[101:72]})) | ({34{(~ sel_w[2])}} & sbit_w[101:68])), ((({34{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[65:34], pad_w[1:0]}) | ({34{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[67:36]})) | ({34{(~ sel_w[1])}} & sbit_w[67:34])), ((({34{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[32:0], pad_w[0]}) | ({34{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[33:1]})) | ({34{(~ sel_w[0])}} & sbit_w[33:0]))};
endmodule //fp_to_fixed_altbarrel_shift_00g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 200 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_to_fixed_altfp_convert_h1n
	( 
	clock,
	dataa,
	result) ;
	...
	wire  [33:0]   wire_altbarrel_shift6_result;
	...
	reg	int_or_reg2;
	reg	int_or_reg3;
	reg	[11:0]	integer_result_reg;
	reg	[10:0]	integer_rounded_reg;
	...
	wire  [10:0]   wire_add_sub7_result;
	wire  wire_add_sub8_cout;
	wire  [4:0]   wire_add_sub8_result;
	wire  [5:0]   wire_add_sub9_result;
	wire  wire_cmpr1_aeb;
	wire  wire_cmpr1_agb;
	wire  wire_cmpr2_aeb;
	wire  wire_cmpr3_alb;
	...
	wire  add_1_cout_w;
	wire  add_1_w;
	wire  [11:0]  all_zeroes_w;
	wire  [33:0]  barrel_mantissa_input;
	wire  [9:0]  barrel_zero_padding_w;
	wire  below_limit_exceeders;
	wire  [11:0]  below_limit_integer;
	...
	wire  [11:0]  exceed_limit_integer;
	...
	wire  [11:0]  infinity_value_w;
	wire  int_or1_w;
	wire  [11:0]  integer_output;
	wire  [10:0]  integer_post_round;
	wire  [10:0]  integer_pre_round;
	wire  [11:0]  integer_result;
	wire  [10:0]  integer_rounded;
	wire  [10:0]  integer_rounded_tmp;
	wire  [10:0]  integer_tmp_output;
	wire  [4:0]  inv_add_1_adder1_w;
	wire  [5:0]  inv_add_1_adder2_w;
	wire  [10:0]  inv_integer;
	wire  [33:0]  lbarrel_shift_result_w;
	wire  [10:0]  lbarrel_shift_w;
	wire  lower_limit_selector;
	wire  lowest_integer_selector;
	wire  [10:0]  lowest_integer_value;
	wire  [10:0]  man_bus1;
	wire  [11:0]  man_bus2;
	wire  [10:0]  man_or1;
	wire  man_or1_w;
	...
	wire  nan_input_w;
	wire  [11:0]  neg_infi_w;
	wire  [7:0]  padded_exponent_input;
	wire  [11:0]  pos_infi_w;
	wire  [5:0]  power2_value_w;
	wire  [11:0]  result_w;
	wire  round_bit_w;
	wire  sign_input;
	wire  sign_input_w;
	wire  [10:0]  signed_integer;
	wire  sticky_bit_w;
	wire  [21:0]  sticky_bus;
	wire  [21:0]  sticky_or;
	wire  [10:0]  unsigned_integer;
	wire  upper_limit_w;
	wire  zero_input_w;

	fp_to_fixed_altbarrel_shift_00g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_result_reg <= 12'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_rounded_reg <= 11'b0;
	...
	assign
		...
		all_zeroes_w = {1'b0, {11{1'b0}}},
		barrel_mantissa_input = {barrel_zero_padding_w, implied_mantissa_input},
		barrel_zero_padding_w = {10{1'b0}},
		below_limit_exceeders = (((denormal_input_w | zero_input_w) | lower_limit_selector) | nan_input_w),
		below_limit_integer = (({12{(~ below_limit_exceeders)}} & integer_output) | ({12{below_limit_exceeders}} & all_zeroes_w)),
		...
		clk_en = 1'b1,
		const_bias_value_add_width_res_w = 8'b10001010,
		...
		exceed_limit_integer = (({12{(~ exceed_limit_exceeders)}} & below_limit_integer) | ({12{exceed_limit_exceeders}} & infinity_value_w)),
		...
		infinity_value_w = (({12{(~ sign_input_w)}} & pos_infi_w) | ({12{sign_input_w}} & neg_infi_w)),
		int_or1_w = man_or2[1],
		...
		integer_rounded = (({11{(~ lowest_integer_selector)}} & integer_rounded_tmp) | ({11{lowest_integer_selector}} & lowest_integer_value)),
		integer_rounded_tmp = (({11{(~ add_1_w)}} & integer_pre_round) | ({11{add_1_w}} & integer_post_round)),
		integer_tmp_output = (({11{(~ sign_input_w)}} & unsigned_integer) | ({11{sign_input_w}} & signed_integer)),
		inv_add_1_adder1_w = wire_add_sub8_result,
		inv_add_1_adder2_w = (({6{(~ wire_add_sub8_cout)}} & inv_integer[10:5]) | ({6{wire_add_sub8_cout}} & wire_add_sub9_result)),
		inv_integer = (~ integer_rounded_reg),
		lbarrel_shift_result_w = wire_altbarrel_shift6_result,
		lbarrel_shift_w = lbarrel_shift_result_w[33:23],
...
endmodule //fp_to_fixed_altfp_convert_h1n
//VALID FILE
...
module fp_to_fixed (
	...
	fp_to_fixed_altfp_convert_h1n	fp_to_fixed_altfp_convert_h1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_to_fixed.cmp TRUE TRUE

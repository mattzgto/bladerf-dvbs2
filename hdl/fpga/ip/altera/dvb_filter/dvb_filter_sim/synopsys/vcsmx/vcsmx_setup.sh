...
# ACDS 17.0 595 linux 2017.07.19.16:34:00
...
# ----------------------------------------
# If dvb_filter is one of several IP cores in your
...
TOP_LEVEL_NAME="dvb_filter"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/spex/intelFPGA_lite/17.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_rtl_core.vhd"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_ast.vhd"                             
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter.vhd"                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_tb.vhd"                              
fi

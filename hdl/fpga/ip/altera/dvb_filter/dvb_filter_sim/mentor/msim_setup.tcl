...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/spex/intelFPGA_lite/17.0/quartus/"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_rtl_core.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_ast.vhd"                             
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter.vhd"                                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dvb_filter_tb.vhd"                              
}
